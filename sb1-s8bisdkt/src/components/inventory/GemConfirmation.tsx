...
interface GemConfirmationProps {
  item: InventoryItem;
  gem: InventoryItem;
  onConfirm: () => void;
  onCancel: () => void;
...
const GemConfirmation: React.FC<GemConfirmationProps> = ({
  item,
  gem,
  onConfirm,
  onCancel,
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-3 border-b border-yellow-900/50 pb-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Insert {gem.name}</p>
          </div>
        </div>

        <p className="text-gray-300 text-sm">
          Are you sure you want to insert {gem.name} into this item?
        </p>
...
export default GemConfirmation;