...
const SoundSettingsMenu: React.FC<SoundSettingsMenuProps> = ({ onClose }) => {
  ...
  const safeGetVolume = () => {
    try {
      return typeof SoundManager.getVolume === "function"
  ...
  const safeGetMusicVolume = () => {
    try {
      return typeof SoundManager.getMusicVolume === "function"
  ...
  const safeGetEffectsVolume = () => {
    try {
      return typeof SoundManager.getEffectsVolume === "function"
  ...
  const safeIsSoundMuted = () => {
    try {
      return typeof SoundManager.isSoundMuted === "function"
  ...
  const safeIsMusicMuted = () => {
    try {
      return typeof SoundManager.isMusicMuted === "function"
  ...
  const safeIsEffectsMuted = () => {
    try {
      return typeof SoundManager.isEffectsMuted === "function"
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-gray-800 border-2 border-gray-600 p-6 rounded-lg w-80 max-w-full">
